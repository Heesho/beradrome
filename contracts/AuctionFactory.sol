...
contract BribePot {
    ...
    function distribute() external {
        address token = IFund(fund).asset();
...
contract Auction {
    ...
    bool public immutable receiverIsFund;
    ...
    /// @param receiverIsFund_ Whether the payment receiver is a fund.
    ...
    constructor(
        ...
        receiverIsFund = receiverIsFund_;
...
contract AuctionFactory is Ownable {
    ...
    function createAuction(
        ...
        Auction auction = new Auction(initPrice, receiverIsFund_, paymentToken_, paymentReceiver_, bribePot_, epochPeriod_, priceMultiplier_, minInitPrice_);

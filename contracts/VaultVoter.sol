...
contract VaultVoter is ReentrancyGuard, Ownable {
     ...
     * @param _vaultFactory VaultFactory address which is used to create vaults
     */
    constructor(address _VTOKEN, address _gaugefactory, address _bribefactory, address _vaultFactory) {
        VTOKEN = _VTOKEN;
